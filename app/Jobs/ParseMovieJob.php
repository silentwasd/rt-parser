    ...
    public function handle(RtService $rt): void
    {
        ...
        $genres = collect($genre[1] ?? [])
            ...
            ->map(fn($genre) => match ($genre) {
                'comedy', 'комедии', 'комеддия', 'комедийные новеллы'                                                       => 'комедия',
                'drama', 'драмы'                                                                                            => 'драма',
                'action', 'экшн', 'экшен'                                                                                   => 'боевик',
                ...
                'драмедия'                                                                                                  => 'драмеди',
                'комедийно-приключенческая'                                                                                 => ['комедия', 'приключения'],
                'историческая драма'                                                                                        => ['история', 'драма'],
                'детекив'                                                                                                   => 'детектив',
                'гей - тема'                                                                                                => 'гей-тема',
                'дзидай геки'                                                                                               => 'дзидай-геки',
                'ниндзя-треш'                                                                                               => ['ниндзя', 'трэш'],
                'духовное кино'                                                                                             => 'духовный',
                'самурайское кино'                                                                                          => 'самурайский',
                "боевые исскуства", "боевые искуства", "бевые искусства", "боевые искуссива", "фильм с боевыми искусствами" => "боевые искусства",
                'комедийный ужастик'                                                                                        => ['комедия', 'ужасы'],
                'pinky violence'                                                                                            => 'пинку-эйга',
                default                                                                                                     => $genre
            })
            ->flatten()
            ->unique()
        ...
        $countries = collect($country[1] ?? [])
            ...
            ->map(fn($country) => match ($country) {
                ...
                'южная корея', 'корея'            => 'Южная Корея',
                'доминиканская республика'        => 'Доминиканская Республика',
                'северная корея', 'кндр'          => 'Северная Корея',
                'гонкон'                          => 'Гонконг',
                default                           => $country
            })
            ->flatten()
        ...
        $releaseName = match (Str::lower($release[1] ?? '')) {
            ...
            'dvd5'                                          => 'DVD5',
            'dvdscr'                                        => 'DVDSCR',
            'dvdrip-avc', 'dvdrip - avc'                    => 'DVDRip-AVC',
            'dvdrip'                                        => 'DVDRip',
            'dvd'                                           => 'DVD',
